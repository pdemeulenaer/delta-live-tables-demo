...
from delta_live_tables_demo import __version__
...
setup(
    ...
    entry_points = {
        "console_scripts": [
            "etl = delta_live_tables_demo.tasks.sample_etl_task:entrypoint",
            "ml = delta_live_tables_demo.tasks.sample_ml_task:entrypoint",
    ]},
    version=__version__,
    description="",
    author="",
